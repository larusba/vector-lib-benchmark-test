 ...
 * 
 * Just changed {@link io.github.jbellis.jvector.vector.VectorSimilarityFunction}  to  {@link SimilarityFunction},
 * in order to be agnostic and handle Lucene Index as well
 */
public class DataSetJVector implements DataSetVector<
